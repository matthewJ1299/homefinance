      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            {...register("categoryId", {
              // `null` is the "no category" value the form resets to, and
              // Number(null) is 0 -- which the schema rejects as not positive
              // and, because nothing renders that error, silently blocked every
              // submit. Anything that is not a real id means None.
              setValueAs: (v) => {
