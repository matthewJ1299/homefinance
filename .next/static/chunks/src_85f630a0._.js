...
"[project]/src/hooks/use-offline-queue.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getQueue() {
    ...
    return new Promise((resolve, reject)=>{
        ...
        req.onsuccess = ()=>{
            var _req_result;
            return resolve((_req_result = req.result) !== null && _req_result !== void 0 ? _req_result : []);
        };
        req.onerror = ()=>reject(req.error);
...
async function clearQueue(tempIds) {
    const db = await openDB();
    return new Promise((resolve, reject)=>{
        const tx = db.transaction(STORE_NAME, "readwrite");
        const store = tx.objectStore(STORE_NAME);
...
function useOfflineQueue() {
    ...
    const refreshQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useOfflineQueue.useCallback[refreshQueue]": async ()=>{
            const q = await getQueue();
            setQueue(q);
        }
    }["useOfflineQueue.useCallback[refreshQueue]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useOfflineQueue.useEffect": ()=>{
            ...
            refreshQueue();
            const onOnline = {
                "useOfflineQueue.useEffect.onOnline": ()=>{
                    setIsOnline(true);
                    refreshQueue();
                }
            }["useOfflineQueue.useEffect.onOnline"];
            const onOffline = {
                "useOfflineQueue.useEffect.onOffline": ()=>setIsOnline(false)
            }["useOfflineQueue.useEffect.onOffline"];
    ...
    const syncQueue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useOfflineQueue.useCallback[syncQueue]": async ()=>{
            const q = await getQueue();
            ...
            const res = await fetch("/api/expenses/sync", {
                ...
                body: JSON.stringify({
                    entries: q.map({
                        "useOfflineQueue.useCallback[syncQueue]": (e)=>({
                                tempId: e.tempId,
                    ...
                    }["useOfflineQueue.useCallback[syncQueue]"])
                })
            });
            if (!res.ok) return;
            const data = await res.json();
            const syncedIds = data.synced.map({
                "useOfflineQueue.useCallback[syncQueue].syncedIds": (s)=>s.tempId
            }["useOfflineQueue.useCallback[syncQueue].syncedIds"]);
...
_s(useOfflineQueue, "bFERQ1SehIx1wDCahA4lMqvEHcg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/layout/offline-indicator.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OfflineIndicator() {
    _s();
    const { isOnline } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$offline$2d$queue$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOfflineQueue"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        ...
        fileName: "[project]/src/components/layout/offline-indicator.tsx",
        lineNumber: 9,
        columnNumber: 5
    }, this);
}
_s(OfflineIndicator, "NiZt8K49Pg5+laPe3tUPS6joah8=", false, function() {
    return [
...
function BottomNav() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "fixed bottom-0 left-0 right-0 z-50 border-t bg-background md:left-auto md:right-0 md:top-14 md:bottom-0 md:w-56 md:border-l md:border-t-0",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex h-14 justify-around md:flex-col md:justify-start md:gap-1 md:p-2 md:h-[calc(100vh-3.5rem)]",
            children: navItems.map((param)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: href,
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex flex-col items-center justify-center gap-0.5 px-4 py-2 text-sm font-medium transition-colors md:flex-row md:justify-start md:gap-2 md:rounded-md", isActive ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-accent"),
                    children: [
...
//# sourceMappingURL=src_85f630a0._.js.map